...
var S={imgs:[],running:false,stop:false,queue:[],done:0,failed:0,style:'disney',ep:'cooking',prompt:'',frame:'wide',intensity:'subtle',frames:153};
...
async function createTask(uri,prompt){var body={model:MODEL,prompt:prompt,image:uri,num_frames:S.frames,frame_rate:24};
...
var u=POLL_BASE+'?video_id='+encodeURIComponent(id)+'&model_name='+encodeURIComponent(MODEL);
