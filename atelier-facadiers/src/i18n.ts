...
export const translations = {
  fr: {
    ...
    materials: {
      ...
      heading1: 'Chaque panneau,',
      headingAccent: 'sa place',
      text: 'Fibrociment, HPL, composite ou laine de roche comprimée : nous façonnons et assemblons vos façades sur-mesure, panneau par panneau.',
    },
  ...
  en: {
    ...
    materials: {
      ...
      heading1: 'Every panel,',
      headingAccent: 'in place',
      text: 'Fibre cement, HPL, composite or compressed mineral wool: we cut and fit your facades to measure, panel by panel.',
    },
    brands: ['Fundermax', 'Trespa', 'PURA', 'EQUITONE', 'Cedral', 'Rockpanel', 'Stacbond', 'Alpolic', 'Fiberdeck'],
