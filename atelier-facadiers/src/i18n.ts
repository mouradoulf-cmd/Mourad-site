...
export const translations = {
  fr: {
    ...
    equitone: {
      ...
      gammesHint: 'Glissez pour explorer les gammes',
      backCta: 'Retour au bardage',
      quoteCta: 'Demander un devis EQUITONE',
      dimensionsHeading: 'Dimensions',
      dimensionsGroups: ['Natura · Pictura · Textura', 'Tectiva', 'Linea', 'Lunara', 'Inspira'],
      dimensionsRows: [
        { label: 'Épaisseur', values: ['8 mm', '8 mm', '10 mm', '10 mm', '8 mm'] },
        { label: 'Masse surfacique', values: ['15,4 kg/m²', '14,4 kg/m²', '16,8 kg/m²', '18,6 kg/m²', '16,8 kg/m²'] },
        { label: 'Classement feu', values: ['A2 -s1, d0', 'A2 -s1, d0', 'A2 -s1, d0', 'A2 -s1, d0', 'A2 -s1, d0'] },
      ],
      formatBrutHeading: 'Format brut',
      formatBrutRows: [
        { label: 'Hauteur', values: ['2530 / 3130 mm', '2520 / 3070 mm', '—', '2520 / 3070 mm', '—'] },
        { label: 'Largeur', values: ['1280 / 1280 mm', '1240 / 1240 mm', '—', '1240 / 1240 mm', '—'] },
        { label: 'Surface', values: ['3,24 / 4,01 m²', '3,12 / 3,81 m²', '—', '3,12 / 3,81 m²', '—'] },
      ],
      formatEquerreHeading: 'Format équerré',
      formatEquerreRows: [
        { label: 'Hauteur', values: ['2500 / 3100 mm', '2500 / 3050 mm', '2500 / 3050 mm', '2500 / 3050 mm', '3100 / 2500 mm'] },
        { label: 'Largeur', values: ['1250 / 1250 mm', '1220 / 1220 mm', '1220 / 1220 mm', '1220 / 1220 mm', '1250 / 1250 mm'] },
        { label: 'Surface', values: ['3,13 / 3,88 m²', '3,05 / 3,72 m²', '3,05 / 3,72 m²', '3,05 / 3,72 m²', '3,88 / 3,13 m²'] },
      ],
      systemsHeading: 'Systèmes',
      fixationLabel: 'Fixation invisible',
      tergoLabel: 'Tergo design',
      systemsParagraphs: [
        "Les panneaux EQUITONE 8 mm peuvent être installés en fixation invisible grâce au système Tergo design. Classé Q4 pour la résistance au choc, il permet d'habiller les rez-de-chaussée. Il se pose en zone sismique sur ossature bois, acier ou alu. Il possède un test LEPIR II pour pose sans bavette de recoupement.",
        "L'Atelier des Façadiers est certifié par le CSTB pour l'usinage du Tergo design.",
      ],
      systemsBadges: ['Classé Q4', 'Test LEPIR II', 'Certifié CSTB'],
      documentationHeading: 'Documentation',
      brochureLabel: 'Brochure EQUITONE',
      brochureCta: 'Demander la brochure',
    },
    study: {
  ...
  en: {
    ...
    equitone: {
      ...
      gammesHint: 'Drag to explore the ranges',
      backCta: 'Back to cladding',
      quoteCta: 'Request an EQUITONE quote',
      dimensionsHeading: 'Dimensions',
      dimensionsGroups: ['Natura · Pictura · Textura', 'Tectiva', 'Linea', 'Lunara', 'Inspira'],
      dimensionsRows: [
        { label: 'Thickness', values: ['8 mm', '8 mm', '10 mm', '10 mm', '8 mm'] },
        { label: 'Surface weight', values: ['15.4 kg/m²', '14.4 kg/m²', '16.8 kg/m²', '18.6 kg/m²', '16.8 kg/m²'] },
        { label: 'Fire rating', values: ['A2 -s1, d0', 'A2 -s1, d0', 'A2 -s1, d0', 'A2 -s1, d0', 'A2 -s1, d0'] },
      ],
      formatBrutHeading: 'Raw format',
      formatBrutRows: [
        { label: 'Height', values: ['2530 / 3130 mm', '2520 / 3070 mm', '—', '2520 / 3070 mm', '—'] },
        { label: 'Width', values: ['1280 / 1280 mm', '1240 / 1240 mm', '—', '1240 / 1240 mm', '—'] },
        { label: 'Area', values: ['3.24 / 4.01 m²', '3.12 / 3.81 m²', '—', '3.12 / 3.81 m²', '—'] },
      ],
      formatEquerreHeading: 'Squared format',
      formatEquerreRows: [
        { label: 'Height', values: ['2500 / 3100 mm', '2500 / 3050 mm', '2500 / 3050 mm', '2500 / 3050 mm', '3100 / 2500 mm'] },
        { label: 'Width', values: ['1250 / 1250 mm', '1220 / 1220 mm', '1220 / 1220 mm', '1220 / 1220 mm', '1250 / 1250 mm'] },
        { label: 'Area', values: ['3.13 / 3.88 m²', '3.05 / 3.72 m²', '3.05 / 3.72 m²', '3.05 / 3.72 m²', '3.88 / 3.13 m²'] },
      ],
      systemsHeading: 'Systems',
      fixationLabel: 'Concealed fixing',
      tergoLabel: 'Tergo design',
      systemsParagraphs: [
        'EQUITONE 8 mm panels can be installed with concealed fixing thanks to the Tergo design system. Rated Q4 for impact resistance, it allows ground floors to be clad. It can be installed in seismic zones on wood, steel or aluminium framework. It has a LEPIR II test for installation without a cover flashing.',
        'Atelier des Façadiers is CSTB-certified for machining Tergo design.',
      ],
      systemsBadges: ['Q4 rated', 'LEPIR II test', 'CSTB certified'],
      documentationHeading: 'Documentation',
      brochureLabel: 'EQUITONE brochure',
      brochureCta: 'Request the brochure',
    },
    study: {
