...
export default function OssatureBrands() {
  ...
  return (
    <section id="ossature" className="relative z-10 pb-6 px-5 sm:px-8">
      <Reveal className="max-w-5xl mx-auto glass-panel rounded-2xl px-6 py-6 flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-8">
